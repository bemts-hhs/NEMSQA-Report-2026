...
# save the table
export_nemsqa_gt(
  gt_object = trauma_04_results_gt,
  measure = "Trauma-04",
  folder = "result",
  extension = "png"
)
...
trauma_04_result_counties_map <- results_to_county_map(df = trauma_04_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")
...
ggplot2::ggsave(
  ...
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Trauma-04/result",
  width = 7,
  height = 6
)

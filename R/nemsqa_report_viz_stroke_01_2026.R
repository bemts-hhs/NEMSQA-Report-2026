### IOWA NEMSQA REPORT VISUALIZATIONS Stroke-01 2025 ---------------------------

###_____________________________________________________________________________
# this script will contain all reporting visualizations for Stroke-01 use:
# nemsqa_report_prep_2025.R to get critical functions into memory
# nemsqa_report_stroke_01_2025.R to generate statistical files for the report
###_____________________________________________________________________________
# assume:
# that nemsqa_report_prep_2025.R was already ran to load needed packages
# and project-specific custom functions in the project
# nemsqa_report_stroke_01_2025.R was ran to generate statistical files
###_____________________________________________________________________________

### DATA -----------------------------------------------------------------------

# import statistical outputs for this measure
import_nemsqa_statistical_files(measure = "Stroke-01")
...
stroke_01_pop_gt <- stroke_01_pop_years |>
  prepare_population_statistical_file() |>
  population_statistical_file_gt(measure = "Stroke-01", fig_dim = c(8, 40)) |>
  tab_style_hhs(
...
stroke_01_results_gt <- stroke_01_result_year |>
...
# save the table
export_nemsqa_gt(
  gt_object = stroke_01_results_gt,
  measure = "Stroke-01",
  folder = "result",
  extension = "png"
)
...
stroke_01_result_counties_map <- results_to_county_map(df = stroke_01_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")

# save the plot
ggplot2::ggsave(
  filename = "stroke_01_result_counties_map.png",
  plot = stroke_01_result_counties_map,
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Stroke-01/result",
  width = 7,
  height = 6
)

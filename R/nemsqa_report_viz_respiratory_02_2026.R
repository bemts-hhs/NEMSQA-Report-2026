### IOWA NEMSQA REPORT VISUALIZATIONS Respiratory-02 2025 ---------------------------
...
# nemsqa_report_respiratory_02_2025.R to generate statistical files for the report
###_____________________________________________________________________________
# assume:
# that nemsqa_report_prep_2025.R was already ran to load needed packages
# and project-specific custom functions in the project
# nemsqa_report_respiratory_02_2025.R was ran to generate statistical files
###_____________________________________________________________________________
...
# save the table
export_nemsqa_gt(
  gt_object = respiratory_02_pop_gt,
...
respiratory_02_results_gt <- respiratory_02_result_year |>
...
# save the table
export_nemsqa_gt(
  gt_object = respiratory_02_results_gt,
  measure = "Respiratory-02",
  folder = "result",
  extension = "png"
)

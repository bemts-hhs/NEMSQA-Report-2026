...
tbi_01_result_counties_map <- results_to_county_map(df = tbi_01_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")
...
ggplot2::ggsave(
  ...
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/TBI-01/result",
  width = 7,
  height = 6
)

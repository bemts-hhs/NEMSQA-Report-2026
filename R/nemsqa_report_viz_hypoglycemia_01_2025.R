...
hypoglycemia_01_pop_gt <- hypoglycemia_01_pop_years |>
  ...
  population_statistical_file_gt(measure = "Hypoglycemia-01", fig_dim = c(8, 40)) |>
  tab_style_hhs(
...
# save the table
export_nemsqa_gt(
  gt_object = hypoglycemia_01_results_gt,
  measure = "Hypoglycemia-01",
  folder = "result",
  extension = "png"
)
...
hypoglycemia_01_result_counties_map <- results_to_county_map(df = hypoglycemia_01_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")
...
ggplot2::ggsave(
  ...
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Hypoglycemia-01/result",
  width = 7.5,
  height = 6
)

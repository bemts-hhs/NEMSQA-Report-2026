...
safety_02_result_counties_map <- results_to_county_map(
  df = safety_02_result_counties,
  add_text = FALSE,
  format = "percent"
)
...
ggplot2::ggsave(
  ...
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2026/output/Safety-02/result",
  width = 7,
  height = 6
)

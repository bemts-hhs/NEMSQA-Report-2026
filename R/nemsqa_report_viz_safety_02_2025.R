### IOWA NEMSQA REPORT VISUALIZATIONS Safety-02 2025 ---------------------------
...
# nemsqa_report_safety_02_2025.R to generate statistical files for the report
###_____________________________________________________________________________
# assume:
# that nemsqa_report_prep_2025.R was already ran to load needed packages
# and project-specific custom functions in the project
# nemsqa_report_safety_02_2025.R was ran to generate statistical files
###_____________________________________________________________________________

### DATA -----------------------------------------------------------------------

# import statistical outputs for this measure
import_nemsqa_statistical_files(measure = "Safety-02")
...
safety_02_pop_gt <- safety_02_pop_years |>
  prepare_population_statistical_file() |>
  population_statistical_file_gt(measure = "Safety-02", fig_dim = c(8, 40)) |>
  tab_style_hhs(
...
safety_02_results_gt <- safety_02_result_year |>
...
# save the table
export_nemsqa_gt(
  gt_object = safety_02_results_gt,
  measure = "Safety-02",
  folder = "result",
  extension = "png"
)
...
safety_02_result_counties_map <- results_to_county_map(df = safety_02_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")

# save the plot
ggplot2::ggsave(
  filename = "safety_02_result_counties_map.png",
  plot = safety_02_result_counties_map,
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Safety-02/result",
  width = 7,
  height = 6
)

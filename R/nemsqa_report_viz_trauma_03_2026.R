### IOWA NEMSQA REPORT VISUALIZATIONS Trauma-03 2025 ---------------------------

###_____________________________________________________________________________
# this script will contain all reporting visualizations for Trauma-03 use:
# nemsqa_report_prep_2025.R to get critical functions into memory
# nemsqa_report_trauma_03_2025.R to generate statistical files for the report
###_____________________________________________________________________________
# assume:
# that nemsqa_report_prep_2025.R was already ran to load needed packages
# and project-specific custom functions in the project
# nemsqa_report_trauma_03_2025.R was ran to generate statistical files
###_____________________________________________________________________________

### DATA -----------------------------------------------------------------------

# import statistical outputs for this measure
import_nemsqa_statistical_files(measure = "Trauma-03")
...
trauma_03_pop_gt <- trauma_03_pop_years |>
  prepare_population_statistical_file() |>
  population_statistical_file_gt(measure = "Trauma-03", fig_dim = c(8, 40)) |>
  tab_style_hhs(
...
trauma_03_results_gt <- trauma_03_result_year |>
...
# save the table
export_nemsqa_gt(
  gt_object = trauma_03_results_gt,
  measure = "Trauma-03",
  folder = "result",
  extension = "png"
)
...
trauma_03_result_counties_map <- results_to_county_map(df = trauma_03_result_counties,
                                                       add_text = FALSE,
                                                       format = "percent")

# save the plot
ggplot2::ggsave(
  filename = "trauma_03_result_counties_map.png",
  plot = trauma_03_result_counties_map,
  path = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/NEMSQA Report/2025/output/Trauma-03/result",
  width = 7,
  height = 6
)
